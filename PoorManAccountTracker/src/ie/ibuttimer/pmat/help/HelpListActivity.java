...
/**
 * An activity representing a list of Help. This activity has different
 ...
 */
public class HelpListActivity extends FragmentActivity implements
		HelpListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.help_detail_container) != null) {
			...
			((HelpListFragment) getSupportFragmentManager().findFragmentById(
					R.id.help_list)).setActivateOnItemClick(true);
		}
	...
	/**
	 * Callback method from {@link HelpListFragment.Callbacks} indicating that
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			arguments.putString(HelpDetailFragment.ARG_ITEM_ID, id);
			...
			detailIntent.putExtra(HelpDetailFragment.ARG_ITEM_ID, id);
