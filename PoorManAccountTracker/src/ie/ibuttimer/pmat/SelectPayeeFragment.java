 ...
 *
 */
public class SelectPayeeFragment extends EditFragment {

	/** Id of layout used by this fragment */
	public static final int LAYOUT_ID = SelectPayee.LAYOUT_ID;
	/** Id of title string used by this fragment */
	public static final int TITLE_ID = SelectPayee.TITLE_ID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        editor = new SelectPayee(getDialog().getContext());
